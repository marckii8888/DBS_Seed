...
const CategoryComponent2 = (props) => {
    var ShopList = {
        "shopList":[
            {
                "name": "Women's Casual Premium Slim Fit T-Shirts",
                "price": 20.3
            },
            {
                "name": "Women's Cotton Jacket",
                "price": 16.99
            },
            {
                "name": "Women's Casual Slim Fit",
                "price": 8.99
            },
        ]
    }
    ...
    <div className="App">
      ...
      <div className="content">
        <div className="ui form">
            <div className="field">
              <label className="formTitle">Women's Clothing</label>
...
ReactDOM.render(<CategoryComponent2 />, document.getElementById("root2"));
